...
export default function App() {
  ...
  useEffect(() => {
    ...
    Audio.setAudioModeAsync({
      ...
      // These settings ensure background audio works in production
  ...
  const extractAudioFromYouTube = async (url: string) => {
    try {
      ...
      // Call our backend API to extract audio using yt-dlp
      // Replace with your Railway URL after deployment
      const response = await fetch('https://YOUR_RAILWAY_URL.up.railway.app/api/extract-audio', {
        method: 'POST',
        headers: {
